...
jmcs_main <- function(tol, k, n1, p1, p2, p1a, maxiter, point, xs, ws, yfile, cfile, mfile, Betasigmafile, Sigcovfile, gamma1, gamma2, trace) {
    .Call(`_FastJM_jmcs_main`, tol, k, n1, p1, p2, p1a, maxiter, point, xs, ws, yfile, cfile, mfile, Betasigmafile, Sigcovfile, gamma1, gamma2, trace)
}

jmcsf_main <- function(tol, k, n1, p1, p2, p1a, maxiter, point, xs, ws, yfile, cfile, mfile, Betasigmafile, Sigcovfile, gammafile, trace) {
    .Call(`_FastJM_jmcsf_main`, tol, k, n1, p1, p2, p1a, maxiter, point, xs, ws, yfile, cfile, mfile, Betasigmafile, Sigcovfile, gammafile, trace)
}

...
#' @importFrom pec ipcw
#' @importFrom magrittr %>%
#' @importFrom stats sd as.formula cov2cor fitted median na.omit rexp residuals delete.response terms rnorm optim pnorm qqline qqnorm quantile vcov model.matrix model.frame runif pchisq complete.cases rbeta
